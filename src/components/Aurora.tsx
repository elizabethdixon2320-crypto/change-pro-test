...
void main() {
  ...
  vec3 auroraColor = intensity * rampColor * 1.15;
  fragColor = vec4(auroraColor * auroraAlpha, auroraAlpha);
}
`

export default function Aurora({
  colorStops = ['#5B86E5', '#36D1DC', '#A3E635'],
  amplitude = 1.0,
  blend = 0.5,
  speed = 1.0,
  className = '',
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      const { speed: sp, amplitude: am, blend: bl, colorStops: cs } = propsRef.current
      program!.uniforms.uTime.value = (t * 0.01 * sp) / 10
      program!.uniforms.uAmplitude.value = am
